...
test.describe('Stars Rating Widget', () => {
    ...
    test.describe('Without stars', () => {
        test("Without stars, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("Without stars, should have correct text", async ({ starsRatingWidgetPage }) => {

            await expect(starsRatingWidgetPage.mainContent).toBeVisible();
            expect(await starsRatingWidgetPage.getCurrentText()).toEqual(expectValues[0].text);
        });

        test("Without stars, should have correct number", async ({ starsRatingWidgetPage }) => {
    ...
    test.describe('With 1 star', () => {
        test("With 1 star, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 1 star, should have correct text", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 1 star, should have correct number", async ({ starsRatingWidgetPage }) => {
    ...
    test.describe('With 2 stars', () => {
        test("With 2 stars, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 2 stars, should have correct text", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 2 stars, should have correct number", async ({ starsRatingWidgetPage }) => {
    ...
    test.describe('With 3 stars', () => {
        test("With 3 stars, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 3 stars, should have correct text", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 3 stars, should have correct number", async ({ starsRatingWidgetPage }) => {
    ...
    test.describe('With 4 stars', () => {
        test("With 4 stars, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 4 stars, should have correct text", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 4 stars, should have correct number", async ({ starsRatingWidgetPage }) => {
    ...
    test.describe('With 5 stars', () => {
        test("With 5 stars, should have correct image", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 5 stars, should have correct text", async ({ starsRatingWidgetPage }) => {
        ...
        test("With 5 stars, should have correct number", async ({ starsRatingWidgetPage }) => {
